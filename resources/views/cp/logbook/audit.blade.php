...
str_contains((string)$a, 'deleted') => 'bg-red-700 text-white',
str_contains((string)$a, 'created') => 'bg-blue text-white',
str_contains((string)$a, 'updated') || str_contains((string)$a, 'saved') => 'bg-blue text-white',
    ...
    <table class="data-table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <span class="px-2 py-1 rounded-full text-xs font-semibold {{ $actionColor($row->action) }}">
                        {{ $row->action }}
                    </span>
                </td>
